 ...
 * 修改内容:
 *
 * 功能描述:一个简单的反射工具类。可以帮助你像写脚本语言一样调用处理java类。
 */
...
public class ReflectUtils {
	 ...
	 * 调用示例：
	 * <p>
	 * ReflectUtils.reflect(application, "mModel.setName(%1).value, new Object[]{"new_name"}, new Class[]{String.class
	 * }, newValue);
	 * <p>
	 *
	 * @param target   需要反射的对象
	 ...
	 * ReflectUtils.reflect(null, "android.app.ActivityThread#currentApplication()");
	 * <p>
	 * ReflectUtils.reflect(application, "mModel.setName(%1).value, new Object[]{"new_name"}, new Class[]{String
	 * .class}, newValue, true);
	 * <p>
	 *
	 * @param target      需要反射的对象
