package com.kawakp.kp.kputilslib.guide;
...
public class GuidesView extends RelativeLayout {
    ...
    public GuidesView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GuidesView(Context context, AttributeSet attrs, int defStyleAttr) {
